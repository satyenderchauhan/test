            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="owners_dataTables">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Id</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        set.dataTable = $('#owners_dataTables').DataTable({
            "processing": true,
            "serverSide": true,
        ...
        $('.dataTables_filter label','#owners_dataTables_wrapper').prepend(btn_pc);
        ...
        $('.changeStatus').click(function(){
            ...
            _this = $(this);
            var ownerId = _this.attr('data-id');
            var status = _this.attr('title');

            $.confirm({
                title: 'Change Status',
                content: '<br><center>Are you sure you want to '+status+' this Owner ?</center><br>',
                ...
                buttons: 
                {
                    submit: 
                    {
                        ...
                        action: function () {
                            ...
                            $.post( bu+"owners/changeStatus", {'owner_id':ownerId ,'status':status}, function( data ) {
